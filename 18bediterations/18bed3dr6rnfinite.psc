...
#new iteration#
# Trying the 6 pt to nurse ratio
#and 3 doctor right now
# 18 pts = 3 cohorts/3nurses
...
R27:
	D_c3 > D_u3
	D_c3 * tau_D * (P_c1 + P_c2 + P_c3 / (P_c1 + P_c2 + P_c3 + P_u1 + P_u2 + P_u3))

R28:
	D_u3 > D_c3
	rho_D * sigma * D_u3 * (P_c1 + P_c2 + P_c3 / (P_c1 + P_c2 + P_c3 + P_u1 + P_u2 + P_u3))
...
rho_N = 7.94 # nurse direct care tasks per patient per hour
...
iota_N = 12.808 #11.92 nurse direct care tasks per hour with 56.55% compliance and 95% efficacy
iota_D = 0.583 #3.25 doctor direct care tasks per hour with 56.55% compliance and 95% efficacy
tau_N = 5.456 #3.30 nurse gown/glove changes per hour with 82.66% compliance
