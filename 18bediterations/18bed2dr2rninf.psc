...
R223:
	P_u4 > P_c4 + Acquisition
	rho_D * psi * P_u4 * (D_c1 / (D_c1 + D_u1)) * (D_c2 / (D_c2 + D_u2))
...
R235:
	P_u5 > P_c5 + Acquisition
	rho_D * psi * P_u5 * (D_c1 / (D_c1 + D_u1)) * (D_c2 / (D_c2 + D_u2))	
...
R247:
	P_u6 > P_c6 + Acquisition
	rho_D * psi * P_u6 * (D_c1 / (D_c1 + D_u1)) * (D_c2 / (D_c2 + D_u2))	
...
R259:
	P_u7 > P_c7 + Acquisition
	rho_D * psi * P_u7 * (D_c1 / (D_c1 + D_u1)) * (D_c2 / (D_c2 + D_u2))	
...
R271:
	P_u8 > P_c8 + Acquisition
	rho_D * psi * P_u8 * (D_c1 / (D_c1 + D_u1)) * (D_c2 / (D_c2 + D_u2))	
...
R283:
	P_u9 > P_c9 + Acquisition
	rho_D * psi * P_u9 * (D_c1 / (D_c1 + D_u1)) * (D_c2 / (D_c2 + D_u2))	
